...
- [ ] Re-evaluate B0 (`base_06b`, `base_17b`) in the same Kaggle session with the extended evaluate.py, replacing the runs from commit 79fc74b (decision 38). `base_06b` on data v1.3 done: `runs/base_06b/metrics.json` at commit 0a0c25e; `base_17b` pending.
