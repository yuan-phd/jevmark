...
- [x] Form nouls: 0 to 2 per record at random positions, per-source thresholds, unbalanceable kinds skipped, exact balance per split. Proof: `tests/test_data.py::test_form_nouls_are_computed_from_the_text_and_exactly_balanced`, `::test_form_nouls_sit_anywhere_and_vary_in_number`, `::test_unbalanceable_kinds_are_skipped`; `tests/test_evaluate.py::test_every_template_maps_to_its_pair_in_both_directions`.
